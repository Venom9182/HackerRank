    ...
    if (message.trim() !== '') {
      ...
      if (showOptions) {
        switch (message.toLowerCase()) {
          case '1':
            setChat([...chat, { text: '1', user: 'user' }, { text: 'FAQs', user: 'ai' }]);
            break;
          case '2':
            setChat([...chat, { text: '2', user: 'user' }, { text: 'Recent Articles', user: 'ai' }]);
            break;
          case '3':
            setChat([...chat, { text: '3', user: 'user' }, { text: 'Connecting to an Agent...', user: 'ai' }]);
            break;
          default:
